...
function LoginPopUp() {
  ...
  return (
    ...
    <div className='px-[20px] p-[10px] *:py-[4px] rounded  bg-white text-[.6em] border-[1px] border-gray-300'>
        ...
        <hr />
        <input type="text" className='h-[30px] w-[95%] mx-[2%] border-[1px] border-gray-300 text-gray-300 font-serif px-[4px]' placeholder='Username' />
        <div className='border-[1px] h-[30px] my-[10px] p-[4px] m-[2%] w-[95%] border-gray-300 flex justify-between items-center'>
          <input type="text" className=' w-[90%]  text-gray-300 font-serif px-[4px]' placeholder='Username' />
          <div 
